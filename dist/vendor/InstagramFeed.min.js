...
(function (a, b) {
  ...
  function d(a, b) {
    var c = localStorage.getItem(a.cache_time_key),
      d =
        0 != a.cache_time &&
        (null === c || parseInt(c) + 60000 * a.cache_time > new Date().getTime());
    d &&
    ...
    switch (a) {
      ...
      case 'location':
        ...
        return (
          ...
          (b = b.entry_data.ProfilePage || b.entry_data.TagPage || b.entry_data.LocationsPage),
          'undefined' != typeof b &&
  ...
  function f(a, b, c, d, g, h) {
    ...
    (j.onload = function () {
      ...
      (j.onerror = function (i) {
        1 < c
          ? (console.warn(
              'Instagram Feed: Request failed, ' + (c - 1) + ' tries left. Retrying...',
            ),
            f(a, b, c - 1, d, g, !h))
          : d(!1, i);
      }),
  ...
  function i(c, d) {
    ...
    if (
      (c.display_profile &&
        ...
        (f +=
          ...
          h(d.profile_pic_url, c.cdnUrlResolver) +
          '" alt="' +
          ('tag' == c.type ? d.name + ' tag pic' : d.username + ' profile pic') +
          '"' +
          e.profile_image +
      ...
      if ('undefined' != typeof d.is_private && !0 === d.is_private)
        f += '<p class="instagram_private"><strong>This profile is private</strong></p>';
      else {
        var j = 'undefined' == typeof k[c.image_size] ? k[640] : k[c.image_size],
          l = (
            d.edge_owner_to_timeline_media ||
            d.edge_hashtag_to_media ||
            d.edge_location_to_media
          ).edges,
          m = l.length > c.items ? c.items : l.length;
        ...
        for (var n = 0; n < m; n++) {
          var o,
            ...
            r = b(l[n], d);
          switch (
            (!1 === r && (r = ('userid' == c.type ? '' : c.id) + ' image'),
            (r = a(r)),
            l[n].node.__typename)
          ) {
            case 'GraphSidecar':
          ...
          (f +=
            ...
            q +
            '"' +
            (c.display_captions ? ' data-caption="' + r + '"' : '') +
            ' class="instagram-' +
            p +
            '" rel="noopener" target="_blank"' +
    ...
    if (c.display_igtv && 'undefined' != typeof d.edge_felix_video_timeline) {
      var s = d.edge_felix_video_timeline.edges,
        m = s.length > c.items ? c.items : s.length;
      if (0 < s.length) {
  ...
  return (
    ...
    function (a) {
      this.valid = !1;
      var b = Object.assign({}, j);
      return ((b = Object.assign(b, a)),
      '' == b.username && '' == b.tag && '' == b.user_id && '' == b.location)
        ? (b.on_error('Instagram Feed: Error, no username, tag or user_id defined.', 1), !1)
        : ('undefined' != typeof a.display_profile &&
          ...
          null == b.callback && '' == b.container
            ? (b.on_error(
              ...
              !1)
            : null != b.cdnUrlResolver && 'function' != typeof b.cdnUrlResolver
            ? (b.on_error('Instagram Feed: options.cdnUrlResolver must be a function or null.'), !1)
            : void ('' == b.username
                ? '' == b.tag
                  ? '' == b.location
              ...
              g(b, function (a) {
                '' != b.container && i(b, a), null != b.callback && b.callback(a);
              }),
              (this.valid = !0)));
    }
  );
