              ...
              if (i.slidesPerColumn > 1) {
                ...
                if ('row' === i.slidesPerColumnFill && i.slidesPerGroup > 1) {
                  ...
                  (A = (D = B - (N = Math.floor(B / H)) * H + G * i.slidesPerGroup) + (N * T) / k),
                    O.css({
                      webkitBoxOrdinalGroup: A,
                      mozBoxOrdinalGroup: A,
                      msFlexOrder: A,
                      webkitOrder: A,
                      order: A,
                    });
  ...
  var K = {
    ...
    de = {
      setTranslate: function () {
        ...
        if (
          (i.css({
            webkitTransformOrigin: '50% 50% -' + o / 2 + 'px',
            mozTransformOrigin: '50% 50% -' + o / 2 + 'px',
            msTransformOrigin: '50% 50% -' + o / 2 + 'px',
            transformOrigin: '50% 50% -' + o / 2 + 'px',
          }),
          p.shadow)
        )
          if (u)
